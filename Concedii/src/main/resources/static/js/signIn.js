...
+'<div id="signinError" class="alert alert-error six columns" style="display:none;">Username and/or password provided are not valid. Please try again.</div></div>',
...
data: function(){return {username: '',
   ...
   //path=/ indicates that the cookie applies to the whole document- this cookie will be set to all urls
          	  ...
          	  //redirect to mvc requst to display the view
          	    document.location.replace("/");//this is for the home page-it redirects
          	  })
