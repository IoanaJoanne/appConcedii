var companyCalendar = {
	template: '<div><h4>Calendar displayed company-wide</h4>'
	...
	/* PT CA PROPS SA FIE DEFINED SI  IN CHILD SCRIPT, NU DOAR IN TEMPLATE, TOATE METODELE SI DIN PARENT SI DIN CHILD 
